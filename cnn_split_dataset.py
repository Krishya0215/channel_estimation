...
best_loss = float('inf')
csv_filename = 'training_metrics_cnn_split_ds.csv'
    ...
    with open(csv_filename, mode='w', newline='') as csv_file:
        ...
        for epoch in range(num_epochs):
            ...
            if avg_val_loss < best_loss:
                ...
                torch.save(model.state_dict(), 'best_model_cnn_split_ds.pth')

            gc.collect()

    # Testing the model
    input_audio_path = 'music/test_input.wav'
    output_audio_path = 'predict/test_output_cnn_split_ds.wav'
    model.load_state_dict(torch.load('best_model_cnn_split_ds.pth', map_location=device))
